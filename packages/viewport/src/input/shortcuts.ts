 ...
 * `packages/engine/modules/pymol/shortcut_dict.py:10-136`.
 *
 ...
 * (`packages/engine/modules/pymol/internal.py:426-511`). Nothing here is ever executed by the
 ...
 * dispatcher only resolves CALLABLES (`packages/bridge/tenmol_bridge/dispatch.py:276`),
 ...
 * `packages/bridge/tests/test_p8_a34.py`), so it cannot drift. An earlier version of
...
/**
 * The five groups the editor and `docs/input-mouse-keyboard.md §15.4`
