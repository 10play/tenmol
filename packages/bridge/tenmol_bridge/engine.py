...
(``packages/engine/layer3/Executive.cpp:11521-11523``), which is ``IdleAndReady == 3``
(``packages/engine/layer5/PyMOL.cpp:2560-2562``, ``IDLE_AND_READY`` at ``:105``); ``IdleAndReady``
...
class Engine:
    ...
    def boot(self) -> None:
        ...
        # G->ShaderMgr->defaultBackbuffer.framebuffer (packages/engine/layer5/PyMOL.cpp:2236-2239).
        ...
        # (packages/engine/layer1/P.cpp:1800-1830), so every option must be set BEFORE start().
        ...
        #  (packages/engine/layer1/Ortho.cpp:492-499, packages/engine/layer1/P.cpp:1820).  NEVER use -c/-cq:
        #  it sets no_gui=1 (packages/engine/modules/pymol/invocation.py:401) and the feedback
        ...
        # file-scope SingletonPyMOLGlobals pointer (packages/engine/layer1/P.cpp:2667); with a
        ...
        # (packages/engine/modules/pymol/locking.py:80-86) reading pymol.glutThread, which is
        # module-level None (packages/engine/modules/pymol/__init__.py:543) and which
        ...
        try:
            ...
            # (packages/engine/layer1/Ortho.cpp:2383-2390) also subtracts MovieGetPanelHeight(),
        ...
        # (packages/engine/layer5/PyMOL.cpp:105); until IdleAndReady reaches it,
    ...
    def tick(self) -> bool:
        ...
        (``packages/engine/layer5/PyMOL.cpp:2279-2286``) and runs ``SeqUpdate``
        (``packages/engine/layer1/Ortho.cpp:1470-1478,1882``).
        """
    ...
    def _install_viewport_seam(self) -> None:
        ...
        THE DEFECT THIS CLOSES.  ``CmdViewport`` (``packages/engine/layer4/Cmd.cpp:4968``) ends
        ...
        (``packages/engine/layer5/PyMOL.cpp:2511-2557``) for the embedding application to
        ...
        ``PyMOL_GetReshapeInfo`` are declared in ``packages/engine/layer5/PyMOL.h:294,300`` and
    ...
    def resize(self, width: int, height: int) -> None:
        ...
        at the first draw (``packages/engine/layer5/PyMOL.cpp:2236-2239``); regenerating the FBO
    ...
    def shutdown(self) -> None:
        ...
        # in PyMOL_Stop (packages/engine/layer5/PyMOL.cpp:2075-2076) and a still-installed
    ...
    def button(self, button: int, state: int, x: int, y: int, modifiers: int) -> None:
        ...
        (``packages/engine/layer0/os_gl_glut_pretend.h:11-26``); ``modifiers`` is the ``cOrtho``
