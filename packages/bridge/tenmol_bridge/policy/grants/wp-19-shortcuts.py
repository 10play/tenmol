...
`save_shortcut` is a real module under `packages/engine/modules/pymol/`, but it is not in
...
GRANT = Grant(
    wp="WP-19",
    note="shortcut persistence: pymol.save_shortcut (packages/engine/modules/pymol/save_shortcut.py)",
    symbols={
