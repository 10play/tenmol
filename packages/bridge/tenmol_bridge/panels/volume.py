...
WHAT WAS BROKEN.  ``packages/engine/modules/pymol/colorramping.py:183-227`` is the entry point
...
pmgapp.menuBar.addcascademenu(...)`` (``packages/engine/modules/pymol/plugins/__init__.py:118``),
