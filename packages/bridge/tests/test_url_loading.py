...
`packages/engine/modules/pymol/internal.py:279-311` takes a filename, an http(s) URL (with a
...
Run::
    ...
    packages/bridge/.venv/bin/python -m pytest packages/bridge/tests/test_url_loading.py -q
"""
