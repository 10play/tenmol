...
``packages/bridge/tests/test_wf_movie.py`` pins the encoder table, the ``.ppm``/``.png``
...
ray (``packages/engine/layer1/Movie.cpp:836``), so upstream ``produce`` runs synchronously and
