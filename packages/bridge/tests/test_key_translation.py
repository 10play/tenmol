...
`packages/viewport/src/input/keys.ts` mirrors `packages/engine/modules/pmg_qt/keymapping.py`.
...
Run::
    ...
    packages/bridge/.venv/bin/python -m pytest packages/bridge/tests/test_key_translation.py -q
"""
...
KEYMAPPING = os.path.join(REPO, "packages", "engine", "modules", "pmg_qt", "keymapping.py")
