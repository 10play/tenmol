...
Run::
    ...
    packages/bridge/.venv/bin/python -m pytest packages/bridge/tests/test_unextractable_reps.py -q
"""
...
def a_map(ws: WSClient):
    ...
    `packages/engine/test/dat` carries no map file, and `map_new` builds one from the structure
