"""Parity area 6 — `cmd.load` core (`packages/engine/modules/pymol/importing.py`).
...
Run::
    ...
    packages/bridge/.venv/bin/python -m pytest packages/bridge/tests/test_load_core.py -q
"""
