...
(``packages/engine/modules/pmg_qt/pymol_qt_gui.py:941-968``), whose second half is the only
...
def test_hsv_fixture_is_what_colorsys_produces_inside_the_engine(ws: Any, bridge: Any) -> None:
    ...
    ``Lib/colorsys.py`` — the module ``packages/engine/modules/pymol/viewing.py:1971`` imports
