...
Run::
    ...
    packages/bridge/.venv/bin/python -m pytest packages/bridge/tests/test_wf_camverify.py -q
"""
...
#: panel module installs it (``packages/bridge/tenmol_bridge/panels/movie.py:413``).
...
ASCII, SPECIAL = -1, -2
#: ``internal.modifier_keys`` / ``cOrthoSHIFT`` (``packages/engine/layer1/Ortho.h:20``) agree: 1.
