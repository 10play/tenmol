...
| `morph` `morph(name, sele1, sele2=None, state1=-1, state2=-1, refinement=3, steps=30, method='rigimol', match='align', quiet=1)` | command | Creates an interpolated multi-state trajectory between two conformations (rigimol incentive-only, or linear). | implemented | [doc](features/topics/fitting-alignment.md#morph) |
