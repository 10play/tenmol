...
// Shard 2 of 8. Probes are round-robin-assigned to shards (see registerShard) so
...
describe('probe-replay (shard 2/8): engine-ts output still equals oracle-verified expected', () => {
  registerShard(2, 8);
});
