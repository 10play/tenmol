...
// Shard 6 of 8. Probes are round-robin-assigned to shards (see registerShard) so
...
describe('probe-replay (shard 6/8): engine-ts output still equals oracle-verified expected', () => {
  registerShard(6, 8);
});
