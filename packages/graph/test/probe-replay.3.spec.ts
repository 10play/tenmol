...
// Shard 3 of 8. Probes are round-robin-assigned to shards (see registerShard) so
...
describe('probe-replay (shard 3/8): engine-ts output still equals oracle-verified expected', () => {
  registerShard(3, 8);
});
