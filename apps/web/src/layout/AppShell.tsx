 ...
 * (packages/engine/modules/pmg_qt/pymol_qt_gui.py:184-193). Everything on the right -- the object
 ...
 * `OrthoLayoutPanel()` (packages/engine/layer1/Ortho.cpp:2261-2340):
 *
 ...
 * packages/engine/layer1/SettingInfo.h:182, packages/engine/layer1/Ortho.h:24). The whole column disappears when
 * `internal_gui` = 0.
 *
 ...
 * scene (`OrthoDrawText`, packages/engine/layer1/Ortho.cpp:1623-1693), and the bottom reading order
 ...
 * exists here.
 * TODO(wizard): the Wizard block (packages/engine/layer1/Wizard.cpp) belongs between the object panel
...
export function AppShell() {
  ...
  const dragColumn = useDrag(
    useCallback((e: PointerEvent) => {
      ...
      // min width 5 mirrors cControlMinWidth (packages/engine/layer1/Control.cpp:263-276)
  ...
  return (
    <div className="shell" ref={rootRef}>
        ...
        {internalGui && (
          <>
            ...
            <div className="internal-gui" style={{ width: panelWidth }}>
              ...
              {/* Wizard block slot (packages/engine/layer1/Wizard.cpp) -- empty until a wizard is active */}
      ...
      {/*
        Not a PyMOL feature: Qt has no QStatusBar (docs/qt-main-window.md §5).
