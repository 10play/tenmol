 ...
 *
 * TODO(color): PyMOL emits `\\933`-style colour escapes (modules/pymol/menu.py:21-23);
 * `colorprinting.text2html` (modules/pymol/colorprinting.py:17) does NOT translate
