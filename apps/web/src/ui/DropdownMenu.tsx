  ...
  return (
    <RadixDropdownMenu.Portal>
      <RadixDropdownMenu.Content
        ...
        className={cn(
          'z-[70] min-w-[12rem] overflow-hidden rounded-[var(--sh-r)] border border-line-strong p-1.5',
          'bg-[var(--sh-panel-frost)] backdrop-blur-2xl backdrop-saturate-150',
          'font-sans text-[12px] text-pm-text shadow-[var(--sh-pop)]',
...
export function DropdownMenuItem({
  ...
  return (
    <RadixDropdownMenu.Item
      ...
      className={cn(
        'relative flex cursor-default select-none items-center gap-2 rounded-[var(--sh-r-sm)] px-2.5 py-1.5',
