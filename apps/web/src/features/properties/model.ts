...
const ONE_LETTER: Record<string, string> = {
  ...
  THR: 'T', TRP: 'W', TYR: 'Y', VAL: 'V', ASX: 'B', GLX: 'Z', MSE: 'M', SEC: 'U',
  PYL: 'O', UNK: 'X', A: 'A', C: 'C', G: 'G', T: 'T', U: 'U',
  DA: 'A', DC: 'C', DG: 'G', DT: 'T', HSD: 'H', HSE: 'H', HSP: 'H', HID: 'H',
  HIE: 'H', HIP: 'H', CYX: 'C', CYM: 'C', ASH: 'D', GLH: 'E', LYN: 'K',
};
