 ...
 * exact message list of `modules/pmg_qt/pymol_qt_gui.py:899-916`. The version
 * string is `cmd.get_version()[0]` (`modules/pymol/querying.py:603`), read from
 * the live engine.
 *
 ...
 * (`layer5/PyMOL.cpp:1954`), so it arrives through the viewport, not here.
 */
