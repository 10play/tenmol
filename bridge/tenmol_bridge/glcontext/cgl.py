...
This is ``docs/webclient/spikes/04-picking.md`` §2/§3 verbatim, promoted to a
...
(``PickColorConverterSetRgbaBitsFromGL``, ``layer1/ScenePicking.cpp:38-84``).

Why the LEGACY profile: PyMOL's non-ES path calls ``glPushMatrix`` /
``glPopMatrix`` (``layer1/ScenePicking.cpp:283,306``) and ``glShadeModel``
