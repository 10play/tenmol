...
``layer1/Wizard.cpp:162-501``).  The dispatcher resolves dotted *module* paths,
...
(``bridge/tests/conftest.py`` documents the chempy/PYMOL_DATA hazard).
