...
(``modules/pymol/_gui.py:377``, harvested into
...
def test_stereo_leaves_do_exactly_what_the_client_table_says(
    ...
    # error before `OpenVRInit` (`layer3/Executive.cpp:9559-9571`).
...
def test_chromadepth_is_not_a_stereo_mode_and_swap_needs_stereo_on(
    ...
    `SceneSetStereo(G, 0)` (`layer3/Executive.cpp:9548-9550`).  `stereo swap` is
