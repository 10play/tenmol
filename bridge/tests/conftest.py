...
``RuntimeError: can only start SingletonPyMOL once`` (``modules/pymol2/__init__.py``),
...
# PYMOL_DATA in os.environ (``modules/pymol/__init__.py:202-210``), and
# ``chempy`` reads them **at import time** to build its data path
# (``modules/chempy/__init__.py:267-274``).  If anything imports chempy first,
