...
Run::
    ...
    bridge/.venv/bin/python -m pytest bridge/tests/test_click_timing.py -q
"""
...
SCENE_MOUSE = os.path.join(REPO, "layer1", "SceneMouse.cpp")
SCENE = os.path.join(REPO, "layer1", "Scene.cpp")
CMD_CPP = os.path.join(REPO, "layer4", "Cmd.cpp")
BLOCK_H = os.path.join(REPO, "layer0", "Block.h")
