---
title: "@tenmol/viewport"
description: "The 3-D viewport: the canvases, both render modes, input forwarding, client-side picking, and the compositor that decides which renderer owns which rep.…"
---
